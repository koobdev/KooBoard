...
public interface FReplyMapper {
	...
	List<FReplyVO> selectlist(@Param("index") int index, @Param("pc") ReplyPageCriteria pc);
	...
	int insert(@Param("reply") FReplyVO reply, @Param("sessionId") String sessionId);
	...
	int update(@Param("reply")FReplyVO reply, @Param("sessionId") String sessionId);
