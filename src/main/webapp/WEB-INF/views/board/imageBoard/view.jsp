		...
		<div class="col-sm-8">
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="text-right">
						...
						<c:if test="${view.b_memId == sessionId}">
							<button type="button" class="btn btn-success" onclick="location.href='imageCorrectBoardForm?b_index=${view.b_index}'">글 수정</button>
							<button type="button" class="btn btn-danger" onclick="location.href='imageDeleteBoard?b_index=${view.b_index}'">글 삭제</button>
						</c:if>
					</div><br/>
					...
					<div class="text-center">
						<form id="recommend" action="imageRecommand?b_index=${view.b_index}" method="post">
							<button type="submit" class="btn btn-primary">추천 ${view.b_recommend}</button>
						</form><br/><br/>
					</div><br/><br/><br/>
					...
					<div>
						<label> 첨부이미지 </label>
						<img src="<%=cp %>/resources/upload/${view.b_fileName}" width="100%">
					</div>
				...
				<div class="card-footer">
									...
									<tr>
										...
										<c:if test="${viewReply.r_memId == sessionId}">
											<td align="right">
												...
												<button type="submit" class="btn btn-outline-danger btn-sm" onclick="location.href='imageReplyDelete?r_index=${viewReply.r_index}&b_index=${view.b_index}'">댓글 삭제</button>
											</td>
										</c:if>
									</tr>
									</c:forEach>
					...
					<!-- 댓글 쓰기 -->
					<div id="show2">
						<jsp:include page="../../reply/imageBoard/replyWrite.jsp" flush="false"/>
					</div>
					
					<!-- 댓글 수정 -->
					<div id="show3">
						<jsp:include page="../../reply/imageBoard/replyCorrect.jsp" flush="false"/>
					</div>
				</div>
			</div>
		</div>
